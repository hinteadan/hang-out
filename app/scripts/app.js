(function (angular) {
    ...
    angular.module('hang-out-app', ['ngRoute', 'ui.bootstrap', 'hang-out-registration', 'hang-out-auth', 'hang-out-browse', 'hang-out-create', 'ui.bootstrap.datetimepicker', 'uiGmapgoogle-maps', 'hang-out-wallpaper', 'hang-out-analytics'])
